...
@section('mainContent')
    @php
        $canViewFullProfile = $can_view_full_profile ?? true;
    @endphp
                    ...
                    <div class="profile-wrapper d-flex flex-wrap align-items-center">
                        <div class="profile-left d-flex flex-wrap align-items-center">
                            ...
                            <div class="profile-info">
                                <h4>{{@$user->name}}</h4>
                                @if($canViewFullProfile && filled(@$user->referral))
                                ...
                                @endif
                                @if($canViewFullProfile && $section_review)
                                    <blockquote class="d-block"><span><i class="fa fa-star"></i> {{$user->total_rating}}</span>
                                    </blockquote>
                                @endif
                                @if($canViewFullProfile && @$user->userInfo && @$user->userInfo->short_description)
                                    ...
                                    <div class="d-flex align-items-enter flex-wrap row-gap-24">
                                        ...
                                        @if($hasAnySocialLink)
                                            <ul class="social_media">
                                                ...
                                                @endif
                                                @if($hasTwitter)
                                                    <li><a href="{{ $user->twitter }}"><svg class="x-twitter-icon"
                                                                                              viewBox="0 0 24 24"
                                                                                              aria-hidden="true"
                                                                                              focusable="false"

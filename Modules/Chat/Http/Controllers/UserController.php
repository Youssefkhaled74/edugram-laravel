...
class UserController extends Controller
{
    ...
    public function invitationRequirementSetting(Request $request)
    {
        ...
        UpdateGeneralSetting('chat_invitation_requirement', $request->invitation_requirement);

        Toastr::success('Invitation requirement setting updated!');
        return redirect()->back();
    }
    ...
    public function settingsUpdate(Request $request)
    {
        ...
        try {
            UpdateGeneralSetting('chatting_method', $request['chat_method']);

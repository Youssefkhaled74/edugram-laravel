                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 d-none">
                        <div class="main-title">
                            <h3 class="mb-0"
                                id="page_title">{{__('payment.Pending')}}  {{__('payment.Offline Payment')}}  </h3>
                        </div>
                    </div>
                    <!-- </div> -->
                                                    ...
                                                    <div class="dropdown CRM_dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right"
                                                            ...
                                                            <a target="_blank" href="{{asset($payment->image)}}"
                                                               class="dropdown-item"
                                                            >{{ __('common.View') }}</a>
                                                            @if (permissionCheck('invoice.offline-payment.approve'))
                                                                @if($payment->status==0)
                                                                    <button data-bs-toggle="modal"
                                                                            data-bs-target="#approve{{@$payment->id}}"
                                                                            class="dropdown-item"
                                                                            type="button">{{ __('common.Approve') }}</button>
                                                                @endif
                                                            @endif
                                                            @if (permissionCheck('invoice.offline-payment.destroy'))
                                                                <button data-bs-toggle="modal"
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="mt-40 d-flex justify-content-between">
                                                                ...
                                                                <form method="POST"
                                                                      action="{{ route('invoice.offline-payment.approve', $payment->id) }}">
                                                                    @csrf
                                                                    @method('PUT')
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="mt-40 d-flex justify-content-between">
                                                                ...
                                                                <form method="get"
                                                                      action="{{route('invoice.offline-payment.destroy', [$payment->id])}}">
                                                                    @csrf
